...
<template>
    ...
    <div
        class="flex min-h-screen flex-col items-center overflow-x-hidden bg-gradient-to-br from-[#FDFDFC] via-blue-50 to-indigo-100 p-6 text-[#1b1b18] lg:justify-center lg:p-8 dark:from-[#0a0a0a] dark:via-gray-900 dark:to-blue-900">
